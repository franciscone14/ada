...
<div class="col-md-2"></div>
    <div style="padding:0%;" class="col-md-8 col-sm-12 col-xs-12 panel panel-primary">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>				    				
                    <td style="width:50%;"><input type="text" id="cidadeEnd" class="form-control" placeholder="Cidade" onblur="addAttr(this);"></td>
                    <td style="width:50%;">
            ...
            <tbody>
                <tr>				    				
                    <td style="width:50%;"><input type="text" id="complementoEnd" class="form-control" placeholder="Casa ou Apartameto" onblur="addAttr(this);"></td>
                    <td style="width:50%;"><input type="text" id="numeroEnd" class="form-control" placeholder="Numero da Residencia" onblur="addAttr(this);"></td>
                </tr>
            </tbody>
